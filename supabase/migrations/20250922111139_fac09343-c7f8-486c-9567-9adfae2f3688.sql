...
-- Update profiles table to store competitive exam selections with categories
-- We'll change competitive_exams to store objects with main_category and sub_category
ALTER TABLE public.profiles 
ALTER COLUMN competitive_exams TYPE JSONB USING competitive_exams::jsonb;
