-- First, let's handle the foreign key constraint by updating existing subjects
-- and inserting new ones without deleting referenced records

-- Update existing subjects or insert new ones
